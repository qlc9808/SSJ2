...
**🐹팀원 김태현** : 로그인/로그아웃 회원가입 기능 및 페이지, 프리미엄 구독 결제 기능
...
**🐹팀원 노보경** : 챌린지 페이지 (인증 관리), 인증글 신고 관리, 메일 보내기

**🐹팀원 민지혜** : 첼린지 정보 상세 조회 및 후기관리, 챌린지 개설 신청, 챌린지 관리(승인/반려)
...
- 회원인 유저는 게시판 작성, 검색, 카테고리 별 분류, 읽기, 수정, 삭제를 할 수 있다.
- 사용자가 게시글 **검색** 또는 **카테고리 변경**을 **요청**하면 **값을 유지한 채로 페이징 처리**가 진행된다.
