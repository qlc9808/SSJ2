	...
	<div id="searchVar" class="container">
		<form action="searching">
			<div class="input-group">
				<input type="search" name="srch_word" id="srch_word"
					class="form-control form-control-underline form-control-sm border-dark" onclick="sh()">
				...
				<div class="col-12">
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade show active" id="popChg">
							<div id="Commu">
								<div id="mySlider" class="flickity-buttons-lg flickity-buttons-offset px-lg-12"
										...
										<div class="col px-4" style="max-width: 400px;">
											<div class="card">
														...
														<c:choose>
															<c:when test="${chg.pickyn > 0}">
																...
																<button type="button"
																	...
																	data-toggle="button"
																	onclick="chgPick(${chg.chg_id})"
																	id="chgPick${chg.chg_id}">
												...
												<a class="text-body" href="chgDetail?chg_id=${chg.chg_id }">
													<c:if test="${chg.thumb != null}">
														<img class="card-img-top"
															src="${pageContext.request.contextPath}/upload/${chg.thumb}"
															alt="thumb"
															style="width: 100%; height: 250px; border-radius: 10px;">
													</c:if>
													<c:if test="${chg.thumb == null}">
														<img class="card-img-top" src="assets/img/chgDfaultImg.png"
															alt="chgDfault"
															style="width: 100%; height: 250px; border-radius: 10px;">
													</c:if>
												</a>
												...
												<div class="card-body py-4 px-0 text-center">
													...
													<a class="text-body fw-bolder text-muted fs-6"
														href="chgDetail?chg_id=${chg.chg_id }">${chg.title }</a>
													<div class="text-muted">
														<fmt:formatDate value="${chg.create_date }"
															pattern="yyyy-MM-dd"></fmt:formatDate>
														~
														<fmt:formatDate value="${chg.end_date }" pattern="yyyy-MM-dd">
														</fmt:formatDate>
													</div>
		...
		<div class="row">
			<div class="col-12">
				...
				<c:forEach var="certList" items="${chgCertList }" varStatus="status">
									...
									<div class="row align-items-center">
										...
										<div class="col-4">
											...
											<a href="/chgDetail?chg_id=${certList.chg_id }">
												<img src="${pageContext.request.contextPath}/upload/${certList.img}"
													alt="certImg" class="img-fluid">
											</a>
										...
										<div class="col-8 ms-n2">
											...
											<div class="d-flex justify-content-between col-12">
												...
												<fmt:parseNumber var="lastRegDatePn"
													value="${lastRegDatePd.time/(1000*60*60*24) }" integerOnly="true" />
												...
												<c:choose>
													<c:when test="${sessionScope.user_num != null }">
														...
														<a class="rate-item" data-toggle="vote" role="button"
															...
															<span
																id="inputLikeCnt${status.index}">${certList.like_cnt}</span>
														</a>
													</c:when>
													...
													<c:otherwise>
														...
														<a class="rate-item" data-toggle="vote"
															data-count="${certList.like_cnt}" href="/loginForm"
															role="button">
															좋아요
															<img alt="heart" src="./images/yr/heart.png">
														</a>
					...
					<!-- 댓글 클릭 시 modal -->
					<div class="modal fade" id="showModal${status.index}" tabindex="-1" role="dialog"
						aria-hidden="true">
							...
							<div class="modal-content"
								...
								<div class="modal-body text-center">
									...
									<c:forEach var="comment" items="${chgCertList }" varStatus="cmtSts">
										<c:choose>
											<c:when
												test="${comment.brd_step > 0 && comment.brd_group == certList.brd_num}">
												<input type="hidden" id="brd_num_cmt${cmtSts.index }"
													value="${comment.brd_num }">
												<div class="review p-5">
													<div class="row d-flex justify-content-between">
														<div class="col-4 text-start">
															<!-- 유저 프로필 사진 -->
									...
									<div class="row mt-5">
										<form id="certCommentForm" action="/commentInsert" method="post"
													...
													<c:choose>
														<c:when test="${certList.chgryn == 1 }">
															...
															<div class="col-12 col-md-6">
																<input type="hidden" name="chg_id"
																	value="${certList.chg_id }">
																<input type="hidden" name="user_num"
																	value="${user.user_num }">
																<input type="hidden" name="brd_num"
																	value="${certList.brd_num }">
															</div>
															...
															<div class="col-12">
																...
																<div class="form-group">
																	<label class="visually-hidden"
																		for="reviewTitle">CertBrd
																		Title:</label>
																	<input class="form-control form-control-sm"
																		id="commentTitle" name="title" type="text"
															...
															<div class="col-12">
																...
																<div class="form-group">
																	<label class="visually-hidden"
																		for="reviewText">CertBrd:</label>
																	<textarea class="form-control form-control-sm"
																		id="commentConts" name="conts" rows="5"
													...
													<div class="col-12">
														...
														<div class="form-group">
															...
															<input class="form-control form-control-sm" type="text"
																name="title" placeholder="로그인 해주세요" disabled="disabled">
														</div>
													</div>
													...
													<div class="col-12">
														...
														<div class="form-group">
															...
															<textarea class="form-control form-control-sm" rows="5"
																name="conts" placeholder="로그인 해주세요"
																disabled="disabled"></textarea>
														</div>
													</div>
												</c:otherwise>
											...
											<div class="col-12 text-center">
												...
												<!-- 닫기 -->
												<button class="btn btn-light btn-sm mx-1" data-bs-dismiss="modal"
													type="button">
													닫기
												</button>
											</div>
		...
		<div class="row">
			<div class="col-12 text-center">
				<form id="more">
					...
					<button type="button" id="moreList" class="btn btn-outline-gray-400 text-muted">더보기▼</button>
				</form>
			</div>
		</div>
	</div>
